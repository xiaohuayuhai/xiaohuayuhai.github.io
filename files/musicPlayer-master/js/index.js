$(function() {
    ...
    var musicImgsData = ['img/tea.jpg', 'img/huahai.jpg', 'img/su.jpg', 'img/dshh.jpg'] // 图片地址数组
    var musicNameData = ['爷爷泡的茶', '花海', '溯', '打上花火']; // 歌曲名数组
    var artistNameData = ['周杰伦', '周杰伦', 'CORSAK胡梦周/马吟吟', '米津玄师'] // 创作歌手数组
    var musicUrls = ['mp3/tea.mp3', 'mp3/huahai.mp3', 'mp3/su.mp3', 'mp3/dshh.mp3']; // 歌曲mp3数组
